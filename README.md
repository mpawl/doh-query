...
doh-query was created to test resolution against Apple's DoH responder: `doh.dns.apple.com`. doh-query can be used to test hostname resolution against this DoH responder. [Details in this blog post](https://medium.com/@mpawl/whats-up-with-doh-dns-apple-com-investigating-apple-s-doh-responder-fce376a19052).
